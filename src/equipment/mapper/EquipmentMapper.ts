...
import { categoriesToEquipmentMap, equipmentToCategoriesMap } from "../../enums/Categories";
import { equipmentToStatusMap, statusToEquipmentMap } from "../../enums/Status";
...
export class EquipmentMapper {
  ...
  static toEntity(dto: ReturnEquipmentDto): Equipment {
    return {
      id: dto.id,
      name: dto.name,
      category: categoriesToEquipmentMap[dto.category],
  ...
  static toReturnDto(equipment: Partial<EquipmentWithReservations>): ReturnEquipmentDto {
